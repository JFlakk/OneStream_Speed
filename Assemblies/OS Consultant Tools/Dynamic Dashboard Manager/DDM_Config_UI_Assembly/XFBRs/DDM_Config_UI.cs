...
namespace Workspace.__WsNamespacePrefix.__WsAssemblyName.BusinessRule.DashboardStringFunction.DDM_Config_UI
{
    public class MainClass
    {
        ...
        public static string Get_DDM_Col_Format(string curr_ted, string curr_DB, string col)
        {
                ...
                case "paneContent":
                    {
                        ...
                        var isVisible = (paneVal == (int)DDM_Config_Helpers.DBPaneContents.CubeView && txtBoxType == "CV") ||
                                         (paneVal == (int)DDM_Config_Helpers.DBPaneContents.Dashboard && txtBoxType == "DB");
        ...
        public class DDMColFormatter
        {
            public static readonly Dictionary<string, ColumnConfig[]> ConfigColumns = new Dictionary<string, ColumnConfig[]>
            {
                { "0b1_DDM_WFProfile_Config_Content", new ColumnConfig[]
                    {
                        new ColumnConfig { ColumnName = "DDM_Config_ID", IsVisible = false, AllowUpdates = false},
                        new ColumnConfig { ColumnName = "Profile_Key", Description = "[Profile Name]", IsVisible = true, AllowUpdates = false, DefaultValue = "|!IV_DDM_trv_WF_Profile!|", ParameterName = "BL_DDM_Root_WFProfiles" },
                        new ColumnConfig { ColumnName = "Profile_Step_Type", Description = "[Profile Step Type]", IsVisible = true, AllowUpdates = false, ParameterName = "DL_DDM_Profile_Step_Type" },
                ...
                { "0b1_DDM_WFProfile_Config_Content", new ColumnConfig[]
                    {
                        ...
                        new ColumnConfig { ColumnName = "Workspace_ID", Description = "Workspace", IsVisible = true },
                        new ColumnConfig { ColumnName = "MaintUnit_ID", Description = "Maintenance Unit", IsVisible = true },
                        new ColumnConfig { ColumnName = "Dashboard_ID", Description = "Dashboard Id", IsVisible = true },
                        new ColumnConfig { ColumnName = "Profile_Key", Description = "Profile Key", IsVisible = true },
                        ...
                        new ColumnConfig { ColumnName = "Layout_Type", Description = "[Layout Type]", IsVisible = true, ParameterName = "DL_DDM_Layout_Type" },
