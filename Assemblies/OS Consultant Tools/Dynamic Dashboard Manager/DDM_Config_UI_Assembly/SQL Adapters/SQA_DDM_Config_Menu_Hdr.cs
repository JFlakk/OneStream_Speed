...
namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
{
    public class SQA_DDM_Config_Menu_Hdr
    {
        ...
        public void Update_DDM_Config_Menu_Hdr(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                try
                {
                    ...
                    GBL_SQA_Helper.BuildInsertCommand(sqa, _connection, transaction, dt, "DDM_Config_Menu_Hdr");
                    GBL_SQA_Helper.BuildUpdateCommand(sqa, _connection, transaction, dt, "DDM_Config_Menu_Hdr", "DDM_Menu_Hdr_ID");
                    GBL_SQA_Helper.BuildDeleteCommand(sqa, _connection, transaction, dt, "DDM_Config_Menu_Hdr", "DDM_Menu_Hdr_ID");
        ...
        /// <summary>
        /// Performs a MERGE operation (upsert) on DDM_Config_Menu_Hdr table
        /// </summary>
        ...
        public void Merge_DDM_Config_Menu_Hdr(SessionInfo si, DataTable dt, bool deleteUnmatched = false, string deleteCondition = null)
        {
            GBL_SQA_Helper.MergeData(si, _connection, dt, "DDM_Config_Menu_Hdr", "DDM_Menu_Hdr_ID", deleteUnmatched, deleteCondition);
        }

        /// <summary>
        /// Synchronizes DDM_Config_Menu_Hdr table with the DataTable (full sync with delete of unmatched records)
        /// </summary>
        /// <param name="si">SessionInfo</param>
        ...
        public void Sync_DDM_Config_Menu_Hdr(SessionInfo si, DataTable dt, string syncCondition = null)
        {
            GBL_SQA_Helper.SyncData(si, _connection, dt, "DDM_Config_Menu_Hdr", "DDM_Menu_Hdr_ID", syncCondition);
        }
    }
}