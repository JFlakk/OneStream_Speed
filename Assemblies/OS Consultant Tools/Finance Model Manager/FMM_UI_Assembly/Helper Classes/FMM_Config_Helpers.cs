		...
		public static class CalcRegistry
		{
			public static readonly Dictionary<CalcType, CalcConfig> Configs = new()
			{
				...
				[CalcType.BRTabletoCube] = new CalcConfig
				{
					ParameterMappings = new()
					{
						{ 0, new Dictionary<string, string> { { "DL_FMM_Calc_Src_CubeType", "Src_Type" } } },
						{ 1, new Dictionary<string, string> { { "IV_FMM_Calc_Src_OpenParen", "Open_Parens" } } },
						{ 2, new Dictionary<string, string> { { "IV_FMM_Calc_Src_MathOperator", "Math_Operator" } } },
						{ 3, new Dictionary<string, string> { { "IV_FMM_Calc_Src_Entity", "Entity" } } },
						{ 4, new Dictionary<string, string> { { "IV_FMM_Calc_Src_Cons", "Cons" } } },
						{ 5, new Dictionary<string, string> { { "IV_FMM_Calc_Src_Scenario", "Scenario" } } },
						{ 6, new Dictionary<string, string> { { "IV_FMM_Calc_Src_Time", "Time" } } },
						{ 7, new Dictionary<string, string> { { "IV_FMM_Calc_Src_Origin", "Origin" } } },
						{ 8, new Dictionary<string, string> { { "IV_FMM_Calc_Src_IC", "IC" } } },
						{ 9, new Dictionary<string, string> { { "IV_FMM_Calc_Src_View", "View" } } },
						{ 10, new Dictionary<string, string> { { "IV_FMM_Calc_Src_Acct", "Acct" } } },
						{ 11, new Dictionary<string, string> { { "IV_FMM_Calc_Src_Flow", "Flow" } } },
						{ 12, new Dictionary<string, string> { { "IV_FMM_Calc_Src_UD1", "UD1" } } },
						{ 13, new Dictionary<string, string> { { "IV_FMM_Calc_Src_UD2", "UD2" } } },
						{ 14, new Dictionary<string, string> { { "IV_FMM_Calc_Src_UD3", "UD3" } } },
						{ 15, new Dictionary<string, string> { { "IV_FMM_Calc_Src_UD4", "UD4" } } },
						{ 16, new Dictionary<string, string> { { "IV_FMM_Calc_Src_UD5", "UD5" } } },
						{ 17, new Dictionary<string, string> { { "IV_FMM_Calc_Src_UD6", "UD6" } } },
						{ 18, new Dictionary<string, string> { { "IV_FMM_Calc_Src_UD7", "UD7" } } },
						{ 19, new Dictionary<string, string> { { "IV_FMM_Calc_Src_UD8", "UD8" } } },
						{ 20, new Dictionary<string, string> { { "IV_FMM_Calc_Src_CloseParens", "Close_Parens" } } }
					}
				},
