...
namespace Workspace.__WsNamespacePrefix.__WsAssemblyName.BusinessRule.DashboardExtender.FMM_Appr_Config_Load_DB
{
    public class MainClass
    {
        ...
        private string CubeConfigOpt = "0_FMM_Cube_Settings";
        ...
        {
            {0, new string[] {"BL_FMM_Setup_Cube_ID"}}
        };
            ...
            try
            {
                ...
                switch (args.FunctionType)
                {
                    case DashboardExtenderFunctionType.LoadDashboard:
                        ...
                        {
                            //							if(args.LoadDashboardTaskInfo.Reason != LoadDashboardReasonType.Initialize && args.LoadDashboardTaskInfo.Aciton != LoadDashboardActionType.BeforeFirstGetParameters) {
        ...
        private void setupUpdateModelDialog(ref XFLoadDashboardTaskResult taskResult)
        {
            ...
            //			DashboardParamDisplayInfo paramInfo = BRApi.Dashboards.Parameters.GetParameterDisplayInfo(si, false, taskResult.ModifiedCustomSubstVars, args.PrimaryDashboard.WorkspaceID, "BL_FMM_Model_ID");
            //			string modelID = taskResult.ModifiedCustomSubstVars.XFGetValue("IV_FMM_Model_ID");
        ...
        private void setParams(ref DashboardExtenderArgs args, ref XFLoadDashboardTaskResult taskResult)
        {
            ...
            if (HierarchyDict.ContainsKey(selectedDashboard))
            {
                ...
                foreach (int dependencyDepth in tempDependencyDict.Keys)
                {
                    ...
                    {
                        //						BRApi.ErrorLog.LogMessage(si, "searching for: " + param);
