...
namespace Workspace.__WsNamespacePrefix.__WsAssemblyName.BusinessRule.DashboardExtender.FMM_Solution_Helper
{
    public class MainClass
    {
            ...
            try
            {
                ...
                { // existing row
                    ...
                    using (var connection = new SqlConnection(dbConnApp.ConnectionString))
                    {
                        ...
                        BRApi.ErrorLog.LogMessage(si, "mcm: " + FMM_Approval_Step_Activity_Config_DT.Rows[0]["Reg_Config_ID"]);
                        // update existing row
                        FMM_Approval_Step_Activity_Config_DT.Rows[0]["Reg_Config_ID"] = Reg_Config_ID;
            ...
            using (var connection = new SqlConnection(dbConnApp.ConnectionString))
            {
                ...
                foreach (DataRow activity_ConfigRow in src_FMM_Activity_Config_DT.Rows)
                {
                    ...
                    foreach (DataRow approval_ConfigRow in src_FMM_Appr_Config_DT.Select($"Act_ID = {curr_srcActivityID}"))
                    {
                        ...
                        : -1; // Handle null Unit_IDs as needed
                        Copy_Approvals(approval_ConfigRow, ref tgt_FMM_Appr_Config_DT, tgt_Cube_ID, ref XFCopyTaskResult);
        ...
        private void get_FMM_Calc_Config_Data(SqlParameter[] src_FMM_Calc_Config_parameters, SqlParameter[] tgt_FMM_Calc_Config_parameters, SQL_FMM_Get_DataSets sql_FMM_Get_DataSets, SQL_Adapter_FMM_Calc_Config sql_Adapter_FMM_Calc_Config, ref DataTable src_FMM_Calc_Config_DT, ref DataTable tgt_FMM_Calc_Config_DT, SQL_FMM_Get_Max_ID sql_FMM_Get_Max_ID)
        {
            ...
            Global_FMM_Calc_ID = sql_FMM_Get_Max_ID.Get_Max_ID(si, "FMM_Calc_Config", "Calc_ID");
        }
        ...
        private void get_FMM_Src_Cell_Data(SqlParameter[] src_FMM_Src_Cell_parameters, SqlParameter[] tgt_FMM_Src_Cell_parameters, SQL_FMM_Get_DataSets sql_FMM_Get_DataSets, SQL_Adapter_FMM_Src_Cell sql_Adapter_FMM_Src_Cell, ref DataTable src_FMM_Src_Cell_DT, ref DataTable tgt_FMM_Src_Cell_DT, SQL_FMM_Get_Max_ID sql_FMM_Get_Max_ID)
        {
            ...
            Global_FMM_Src_Cell_ID = sql_FMM_Get_Max_ID.Get_Max_ID(si, "FMM_Src_Cell", "Cell_ID");
        }
        ...
        private void Copy_Reg_Config(DataRow src_Reg_Config_Row, ref DataTable tgt_Reg_Config_DT, int targetCubeID, ref XFSelectionChangedTaskResult XFCopyTaskResult)
        {
            ...
            if (!isDuplicate)
            {
                ...
                newTargetRow["Approval_Config"] = src_Reg_Config_Row.Field<string>("Approval_Config") ?? string.Empty; // Handle nulls
            ...
            else
            {
                ...
                if (existingRow != null)
                {
                    ...
                    existingRow["Approval_Config"] = src_Reg_Config_Row.Field<string>("Approval_Config") ?? existingRow.Field<string>("Approval_Config");
        ...
        private void Copy_Calcs(DataRow src_Calc_Config_Row, ref DataTable tgt_Calc_Config_DT, int targetCubeID, ref XFSelectionChangedTaskResult XFCopyTaskResult, string RunType)
        {
            ...
            if (RunType == "Model Calc Copy" || !isDuplicate)
            {
                ...
                newTargetRow["Calc_ID"] = Global_FMM_Calc_ID;
            ...
            else
            {
                ...
                if (existingRow != null)
                {
                    Global_Curr_FMM_Calc_ID = existingRow.Field<int>("Calc_ID");
                    existingRow["Status"] = row_Status;
        ...
        private void Copy_Cell(DataRow src_Cell_Config_Row, ref DataTable tgt_Cell_Config_DT, int targetCubeID, ref XFSelectionChangedTaskResult XFCopyTaskResult)
        {
            ...
            bool isDuplicate = tgt_Cell_Config_DT.AsEnumerable()
                .Any(row => row["Act_ID"].ToString() == Global_Curr_FMM_Act_ID.ToString() &&
                            row["Model_ID"].ToString() == Global_Curr_FMM_Models_ID.ToString() &&
                            row["Calc_ID"].ToString() == Global_Curr_FMM_Calc_ID.ToString());
            ...
            if (!isDuplicate)
            {
                ...
                newTargetRow["Model_ID"] = Global_Curr_FMM_Models_ID;
                newTargetRow["Calc_ID"] = Global_Curr_FMM_Calc_ID;
        ...
        private void Copy_Src_Cell(DataRow src_Src_Cell_Config_Row, ref DataTable tgt_Src_Cell_Config_DT, int targetCubeID, ref XFSelectionChangedTaskResult XFCopyTaskResult)
        {
            ...
            bool isDuplicate = tgt_Src_Cell_Config_DT.AsEnumerable()
                .Any(row => row["Act_ID"].ToString() == Global_Curr_FMM_Act_ID.ToString() &&
                            row["Model_ID"].ToString() == Global_Curr_FMM_Models_ID.ToString() &&
                            row["Calc_ID"].ToString() == Global_Curr_FMM_Calc_ID.ToString() &&
                            row["Cell_ID"].ToString() == Global_Curr_FMM_Src_Cell_ID.ToString());
            ...
            if (!isDuplicate)
            {
                ...
                newTargetRow["Model_ID"] = Global_Curr_FMM_Models_ID;
                newTargetRow["Calc_ID"] = Global_Curr_FMM_Calc_ID;
                newTargetRow["Cell_ID"] = Global_FMM_Src_Cell_ID;
            ...
            else
            {
                ...
                if (existingRow != null)
                {
                    Global_Curr_FMM_Src_Cell_ID = Convert.ToInt32(existingRow["Cell_ID"].ToString());
        ...
        private void Duplicate_Model_List(int Cube_ID, int Act_ID, String Dup_Process_Step, ref XFSqlTableEditorSaveDataTaskResult Save_Data_Task_Result)
        {
            try
            {
        ...
        private void Duplicate_Model_Grp_List(int Cube_ID, String Dup_Process_Step, ref XFSqlTableEditorSaveDataTaskResult Save_Data_Task_Result)
        {
            try
            {
                switch (Dup_Process_Step)
                {
                    case "Initiate":
                        ...
                        using (var connection = new SqlConnection(dbConnApp.ConnectionString))
                        {
                            ...
                            {
                                string Model_GroupKey = Cube_ID + "|" + (int)cube_Model_Grp_Row["Model_Grp_ID"];
