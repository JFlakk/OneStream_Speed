    ...
    public class SQA_FMM_Model_Grp_Seqs
    {
        ...
        public void Update_FMM_Model_Grp_Seqs(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            ...
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                ...
                string insertQuery = @"
                    INSERT INTO FMM_Model_Grp_Seqs
                        (Cube_ID, Model_Grp_Seq_ID, Name, Status,
                ...
                sqa.UpdateCommand.Parameters.Add(new SqlParameter("@Model_Grp_Seq_ID", SqlDbType.Int) { SourceColumn = "Model_Grp_Seq_ID", SourceVersion = DataRowVersion.Original });
