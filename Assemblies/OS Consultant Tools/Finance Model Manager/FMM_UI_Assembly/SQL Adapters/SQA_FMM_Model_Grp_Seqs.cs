...
namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
{
    public class SQA_FMM_Model_Grp_Seqs
    {
        ...
        public void Update_FMM_Model_Grp_Seqs(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            ...
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                try
                {
                    ...
                    GBL_SQA_Helper.BuildInsertCommand(sqa, _connection, transaction, dt, "FMM_Model_Grp_Seqs");
                    GBL_SQA_Helper.BuildUpdateCommand(sqa, _connection, transaction, dt, "FMM_Model_Grp_Seqs", "Model_Grp_Seq_ID");
                    GBL_SQA_Helper.BuildDeleteCommand(sqa, _connection, transaction, dt, "FMM_Model_Grp_Seqs", "Model_Grp_Seq_ID");
        ...
        /// <summary>
        /// Performs a MERGE operation (upsert) on FMM_Model_Grp_Seqs table
        /// </summary>
        ...
        public void Merge_FMM_Model_Grp_Seqs(SessionInfo si, DataTable dt, bool deleteUnmatched = false, string deleteCondition = null)
        {
            GBL_SQA_Helper.MergeData(si, _connection, dt, "FMM_Model_Grp_Seqs", "Model_Grp_Seq_ID", deleteUnmatched, deleteCondition);
        }

        /// <summary>
        /// Synchronizes FMM_Model_Grp_Seqs table with the DataTable (full sync with delete of unmatched records)
        /// </summary>
        /// <param name="si">SessionInfo</param>
        ...
        public void Sync_FMM_Model_Grp_Seqs(SessionInfo si, DataTable dt, string syncCondition = null)
        {
            GBL_SQA_Helper.SyncData(si, _connection, dt, "FMM_Model_Grp_Seqs", "Model_Grp_Seq_ID", syncCondition);
        }
    }
}