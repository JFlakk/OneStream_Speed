...
namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
{
    public class SQA_FMM_Appr_Step_Config
    {
        ...
        public void Update_FMM_Appr_Step_Config(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            ...
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                try
                {
                    ...
                    GBL_SQA_Helper.BuildInsertCommand(sqa, _connection, transaction, dt, "FMM_Appr_Step_Config");
                    GBL_SQA_Helper.BuildUpdateCommand(sqa, _connection, transaction, dt, "FMM_Appr_Step_Config", "Appr_Step_ID");
                    GBL_SQA_Helper.BuildDeleteCommand(sqa, _connection, transaction, dt, "FMM_Appr_Step_Config", "Appr_Step_ID");
        ...
        /// <summary>
        /// Performs a MERGE operation (upsert) on FMM_Appr_Step_Config table
        /// </summary>
        ...
        public void Merge_FMM_Appr_Step_Config(SessionInfo si, DataTable dt, bool deleteUnmatched = false, string deleteCondition = null)
        {
            GBL_SQA_Helper.MergeData(si, _connection, dt, "FMM_Appr_Step_Config", "Appr_Step_ID", deleteUnmatched, deleteCondition);
        }

        /// <summary>
        /// Synchronizes FMM_Appr_Step_Config table with the DataTable (full sync with delete of unmatched records)
        /// </summary>
        /// <param name="si">SessionInfo</param>
        ...
        public void Sync_FMM_Appr_Step_Config(SessionInfo si, DataTable dt, string syncCondition = null)
        {
            GBL_SQA_Helper.SyncData(si, _connection, dt, "FMM_Appr_Step_Config", "Appr_Step_ID", syncCondition);
        }
    }
}