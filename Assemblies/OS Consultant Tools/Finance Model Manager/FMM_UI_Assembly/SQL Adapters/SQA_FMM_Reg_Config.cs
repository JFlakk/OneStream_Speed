        ...
        public void Update_FMM_Reg_Config(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                try
                {
                    ...
                    var builder = new GBL_SQL_Command_Builder(_connection, "FMM_Reg_Config", dt);
                    builder.SetPrimaryKey("Reg_ID");
                    builder.ExcludeFromUpdate("Reg_ID", "Cube_ID", "Act_ID", "Create_Date", "Create_User");
