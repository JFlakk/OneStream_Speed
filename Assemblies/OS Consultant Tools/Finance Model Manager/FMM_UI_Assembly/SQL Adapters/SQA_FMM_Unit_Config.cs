    ...
    public class SQA_FMM_Unit_Config
    {
        ...
        public void Update_FMM_Unit_Config(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            var columnDefinitions = new List<ColumnDefinition>
            {
                ...
                new ColumnDefinition("Unit_ID", SqlDbType.Int),
            ...
            var primaryKeyColumns = new List<string> { "Unit_ID" };

            _helper.UpdateDataTable(si, dt, sqa, "FMM_Unit_Config", columnDefinitions, primaryKeyColumns, autoTimestamps: false);
        }
    }
}