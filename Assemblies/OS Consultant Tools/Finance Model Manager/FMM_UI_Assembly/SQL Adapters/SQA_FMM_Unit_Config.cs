        ...
        public void Update_FMM_Unit_Config(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                try
                {
                    ...
                    var builder = new GBL_SQL_Command_Builder(_connection, "FMM_Unit_Config", dt);
                    builder.SetPrimaryKey("Unit_ID");
                    builder.ExcludeFromUpdate("Unit_ID", "Cube_ID", "Act_ID", "Create_Date", "Create_User");
