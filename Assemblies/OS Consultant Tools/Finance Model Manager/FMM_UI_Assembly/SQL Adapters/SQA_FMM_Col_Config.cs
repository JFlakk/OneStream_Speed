        ...
        public void Update_FMM_Col_Config(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                try
                {
                    ...
                    var builder = new GBL_SQL_Command_Builder(_connection, "FMM_Col_Config", dt);
                    builder.SetPrimaryKey("Col_ID");
                    builder.ExcludeFromUpdate("Col_ID", "Cube_ID", "Act_ID", "Create_Date", "Create_User");
