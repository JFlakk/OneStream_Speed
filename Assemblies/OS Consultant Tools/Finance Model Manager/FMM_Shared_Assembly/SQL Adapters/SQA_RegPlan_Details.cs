        ...
        public void Update_RegPlan_Details(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                try
                {
                    ...
                    var builder = new GBL_SQL_Command_Builder(_connection, "RegPlan_Details", dt);
                    builder.SetPrimaryKey("Detail_ID");
                    builder.ExcludeFromUpdate("Detail_ID", "RegPlan_ID", "Create_Date", "Create_User");
