...
namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
{
    public class SQA_RegPlan
    {
        ...
        {{
            ...
            {{
                ...
                {{
                    ...
                    GBL_SQA_Helper.BuildInsertCommand(sqa, _connection, transaction, dt, "RegPlan");
                    GBL_SQA_Helper.BuildUpdateCommand(sqa, _connection, transaction, dt, "RegPlan", "RegPlan_ID");
                    GBL_SQA_Helper.BuildDeleteCommand(sqa, _connection, transaction, dt, "RegPlan", "RegPlan_ID");
        ...
        /// <summary>
        /// Performs a MERGE operation (upsert) on RegPlan table
        /// </summary>
        ...
        public void Merge_RegPlan(SessionInfo si, DataTable dt, bool deleteUnmatched = false, string deleteCondition = null)
        {{
            GBL_SQA_Helper.MergeData(si, _connection, dt, "RegPlan", "RegPlan_ID", deleteUnmatched, deleteCondition);
        }}

        /// <summary>
        /// Synchronizes RegPlan table with the DataTable (full sync with delete of unmatched records)
        /// </summary>
        /// <param name="si">SessionInfo</param>
        ...
        public void Sync_RegPlan(SessionInfo si, DataTable dt, string syncCondition = null)
        {{
            GBL_SQA_Helper.SyncData(si, _connection, dt, "RegPlan", "RegPlan_ID", syncCondition);
        }}
    }
}