        ...
        public void Update_RegPlan(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                try
                {
                    ...
                    var builder = new GBL_SQL_Command_Builder(_connection, "RegPlan", dt);
                    builder.SetPrimaryKey("RegPlan_ID");
                    builder.ExcludeFromUpdate("RegPlan_ID", "WFScenario_Name", "WFProfile_Name", "WFTime_Name", "Create_Date", "Create_User");
