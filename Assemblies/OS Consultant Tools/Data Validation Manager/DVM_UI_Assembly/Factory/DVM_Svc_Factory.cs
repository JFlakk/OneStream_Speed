...
{
    public class DVM_Svc_Factory : IWsAssemblyServiceFactory
    {
            ...
            string itemName)
        {
            try
            {
                ...
                {
                    WsAssemblyServiceType.DynamicDashboards => new DVM_DynDB_Svc(),
                    WsAssemblyServiceType.Dashboard         => new DVM_DB_Svc(),
