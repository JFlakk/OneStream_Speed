...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class GBL_ColumnMap
	    ...
	    ' Constructor
	    Public Sub New(csvName As String, dbName As String, colType As Type, required As Boolean, Validation As String, Optional Dimension As String = "", Optional Token As String = "", Optional maxLength As Integer = 0)
