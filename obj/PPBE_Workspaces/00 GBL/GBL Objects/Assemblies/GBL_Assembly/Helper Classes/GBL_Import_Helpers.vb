				...
				Else
					For i As Integer = 0 To csvHeaders.Length - 1
						If headerMapDict.ContainsKey(i) Then
							...
							newRow(i) = rawValue
'If i < 4 Then BRApi.ErrorLog.LogMessage(si,i & " @rawValue: " & rawValue & " ;header nam:e " & headerMapDict(i).CsvHeaderName & "; mapping name: " & mapping.CsvHeaderName & " ;newrow(i): " & newRow(i) & " ; Item(i).ColumnName : " & newRow.Table.Columns.Item(i).ColumnName & " ; newrow(APPN) : " & newRow("APPN") & " ; newrow(REQ_ID) : " & newRow("REQ_ID"))
...
'BRApi.ErrorLog.LogMessage(si, "Entity: " & mapping.DataTableColumnName & " = " & rawValue)									
								...
								Case "member"
									rawValue = CleanUpSpecialCharacters(rawValue)
'BRApi.ErrorLog.LogMessage(si, "Before mapping.ValDim: " & mapping.DataTableColumnName & " = " & rawValue)																											
...
'BRApi.ErrorLog.LogMessage(si, $"_{Dimension}_{Value}_")			
