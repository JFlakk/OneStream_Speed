...
'Brapi.ErrorLog.LogMessage(si, "orig title: " & newRow("APPN").ToString & ", new title : " & originalRow("Title").ToString)
			Return newRow
		End Function
...
'	Public Class GBL_DataSet
'		Public si As SessionInfo
'        Public globals As BRGlobals
'        Public api As Object
'        Public args As DashboardStringFunctionArgs
'		Public GBL_DataSet As New Workspace.GBL.GBL_Assembly.BusinessRule.DashboardDataSet.GBL_DB_DataSet.MainClass()
'		Public Function returnSecGroups() As Object '(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As Object, ByVal args As DashboardDataSetArgs) As Object
''brapi.ErrorLog.LogMessage(si, "Inside GBL_DataSet")			
...
'			Dim userSecurity_dt As DataTable = GBL_DataSet.Main(si, globals, api, dsArgs)	
''brapi.ErrorLog.LogMessage(si, "after datasetcall")					
'			Return userSecurity_dt
'		End Function	
'	End Class
