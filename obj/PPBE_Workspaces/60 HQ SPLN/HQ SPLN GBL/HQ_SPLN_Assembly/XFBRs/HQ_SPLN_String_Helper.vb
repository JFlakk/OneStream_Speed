...
#Region "Main"		
		Public Function Main(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As Object, ByVal args As DashboardStringFunctionArgs) As Object
			Try
				If args.FunctionName.XFEqualsIgnoreCase("ParseCommand") Then
				...
				If args.FunctionName.XFEqualsIgnoreCase("BalanceCheck") Then
					Return Me.BalanceCheck(si, args)
				End If
...
'brapi.ErrorLog.LogMessage(si,"CM Hit 1")
				...
				If args.FunctionName.XFEqualsIgnoreCase("HQ_SPLN_Details_Intersection") Then
					Return Me.HQ_SPLN_Details_Intersection(si, globals, api, args)
				End If
...
'Obligation account or Commitment account for variance column
		Private Function BalanceCheck(ByVal si As SessionInfo, ByVal args As DashboardStringFunctionArgs) As String
			Try
'				Dim Variance As String = args.NameValuePairs.XFGetValue("Variance","")
...
#Region "Return CMD HQ Details Intersections"
	Public Function HQ_SPLN_Details_Intersection(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As Object, ByVal args As DashboardStringFunctionArgs) As Object
		Dim sCube As String = BRApi.Workflow.Metadata.GetProfile(si, si.WorkflowClusterPk.ProfileKey).CubeName	
		Dim sEntity As String = BRapi.Finance.Entity.Text(si, BRapi.Finance.Members.GetMemberId(si,dimtype.Entity.Id, sCube), 1, 0, 0).Trim & "_General"
		Dim Scenario As String = args.NameValuePairs("Scenario")
		Dim Time As String = args.NameValuePairs("Time")
		Dim View As String = args.NameValuePairs("View")
		Dim Account As String = args.NameValuePairs("Account")
...
#Region "GetDODRate:"
	...
	Public Function GetDODRate(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As Object, ByVal args As DashboardStringFunctionArgs) As String
		Try
			...
			Dim sAppn As String = wfprofilesubstring.Replace(" Validate","")
			Dim sEntity As String = BRapi.Finance.Entity.Text(si, BRapi.Finance.Members.GetMemberId(si,dimtype.Entity.Id, sCube), 1, 0, 0) & "_General"
			Dim sMemberScript As String = "Cb#" & sCube & ":E#" & sEntity & ":C#Local:S#" & sScenario & ":T#" & sTime & "M10:V#Periodic:A#DOD_Rate_Calc:F#None:O#BeforeAdj:I#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None:U8#None"
