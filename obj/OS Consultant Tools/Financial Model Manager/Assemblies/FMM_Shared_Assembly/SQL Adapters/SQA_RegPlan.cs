...
namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
{
    public class SQA_Reg_Plan_Details
    {
        ...
        public void Fill_Register_Plan_Details_DataTable(SessionInfo si, SqlDataAdapter sqa, DataTable dataTable, string selectQuery, params SqlParameter[] parameters)
        {
        ...
        public void Update_Register_Plan_Details(SessionInfo si, DataTable dataTable, SqlDataAdapter sqa)
        {
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                ...
                sqa.InsertCommand.Parameters.Add("@Register_Plan_ID", SqlDbType.UniqueIdentifier).SourceColumn = "Register_Plan_ID";
                sqa.InsertCommand.Parameters.Add("@WF_Scenario_Name", SqlDbType.NVarChar, 100).SourceColumn = "WF_Scenario_Name";
                sqa.InsertCommand.Parameters.Add("@WF_Profile_Name", SqlDbType.NVarChar, 100).SourceColumn = "WF_Profile_Name";
                sqa.InsertCommand.Parameters.Add("@WF_Time_Name", SqlDbType.NVarChar, 100).SourceColumn = "WF_Time_Name";
                ...
                sqa.InsertCommand.Parameters.Add("@Approval_Level_ID", SqlDbType.UniqueIdentifier).SourceColumn = "Approval_Level_ID";
                sqa.InsertCommand.Parameters.Add("@Plan_Units", SqlDbType.NVarChar, 20).SourceColumn = "Plan_Units";
                ...
                sqa.InsertCommand.Parameters.Add(new SqlParameter("@Create_User", SqlDbType.NVarChar, 50) { Value = si.UserName });
                sqa.InsertCommand.Parameters.Add(new SqlParameter("@Update_User", SqlDbType.NVarChar, 50) { Value = si.UserName });
                ...
                sqa.DeleteCommand.Parameters.Add(new SqlParameter("@Register_Plan_ID", SqlDbType.UniqueIdentifier) { SourceColumn = "Register_Plan_ID", SourceVersion = DataRowVersion.Original });
                ...
                sqa.DeleteCommand.Parameters.Add(new SqlParameter("@Plan_Units", SqlDbType.NVarChar, 20) { SourceColumn = "Plan_Units", SourceVersion = DataRowVersion.Original });
