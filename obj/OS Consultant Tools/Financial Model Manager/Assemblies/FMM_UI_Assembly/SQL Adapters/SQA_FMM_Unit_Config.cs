    ...
    public class SQA_FMM_Unit_Config
    {
        ...
        public void Update_FMM_Unit_Config(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                ...
                string insertQuery = @"
                    INSERT INTO FMM_Unit_Config (
                        Cube_ID, Act_ID, Unit_ID, Name, Status, 
                ...
                sqa.UpdateCommand.Parameters.Add(new SqlParameter("@Unit_ID", SqlDbType.Int) { SourceColumn = "Unit_ID", SourceVersion = DataRowVersion.Original });
                ...
                string deleteQuery = @"
                    DELETE FROM FMM_Unit_Config 
                    WHERE Unit_ID = @Unit_ID";
                sqa.DeleteCommand = new SqlCommand(deleteQuery, _connection, transaction);
                sqa.DeleteCommand.Parameters.Add(new SqlParameter("@Unit_ID", SqlDbType.Int) { SourceColumn = "Unit_ID", SourceVersion = DataRowVersion.Original });
