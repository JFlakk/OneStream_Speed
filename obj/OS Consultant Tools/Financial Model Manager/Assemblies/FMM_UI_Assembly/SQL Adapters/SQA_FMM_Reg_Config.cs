    ...
    public class SQA_FMM_Reg_Config
    {
        ...
        public void Update_FMM_Reg_Config(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            ...
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                ...
                sqa.InsertCommand.Parameters.Add("@Time_Phasing_Driver", SqlDbType.NVarChar, 50).SourceColumn = "Time_Phasing_Driver";
                ...
                sqa.UpdateCommand.Parameters.Add("@Time_Phasing_Driver", SqlDbType.NVarChar, 50).SourceColumn = "Time_Phasing_Driver";
