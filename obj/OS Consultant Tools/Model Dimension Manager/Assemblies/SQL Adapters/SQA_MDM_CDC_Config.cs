...
namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
{
    public class SQA_MDM_CDC_Config
    {
        ...
        public SQA_MDM_CDC_Config(SqlConnection connection)
        {
            _connection = connection;
        }

        public void Fill_MDM_CDC_Config_DT(SessionInfo si, SqlDataAdapter sqa,DataTable dt, string sql, params SqlParameter[] sqlparams)
        {
            ...
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                string insertQuery = @"
                    INSERT INTO MDM_CDC_Config (
                        CDC_Config_ID, Name, Dim_Type, Dim_ID, Src_Connection, Src_SQL_String,
                ...
                string updateQuery = @"
                    UPDATE MDM_CDC_Config SET
                        Name = @Name, Dim_Type = @Dim_Type, Dim_ID = @Dim_ID, Src_Connection = @Src_Connection,
                        Src_SQL_String = @Src_SQL_String, Dim_Mgmt_Process = @Dim_Mgmt_Process, Trx_Rule = @Trx_Rule,
                        Appr_ID = @Appr_ID, Mbr_PrefSuff = @Mbr_PrefSuff, Mbr_PrefSuff_Txt = @Mbr_PrefSuff_Txt,
                ...
                string deleteQuery = @"DELETE FROM MDM_CDC_Config WHERE CDC_Config_ID = @CDC_Config_ID";
