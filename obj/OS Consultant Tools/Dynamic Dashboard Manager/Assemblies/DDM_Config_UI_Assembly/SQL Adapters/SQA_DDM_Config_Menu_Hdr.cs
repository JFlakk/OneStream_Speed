    ...
    public class SQA_DDM_Config_Menu_Hdr
    {
        ...
        public void Update_DDM_Config_Menu_Hdr(SessionInfo si, DataTable dt, SqlDataAdapter sqa)
        {
            using (SqlTransaction transaction = _connection.BeginTransaction())
            {
                ...
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Order", SqlDbType.Int).SourceColumn = "DDM_Menu_Hdr_Order";
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Option_Type", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Option_Type";
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Dim_Type", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_Dim_Type";
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Dim_Name", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_Dim_Name";
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_MFB", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_MFB";
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Default", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_Default";
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Btn", SqlDbType.Bit).SourceColumn = "DDM_Menu_Hdr_Fltr_Btn";
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Btn_Lbl", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_Btn_Lbl";
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Btn_ToolTip", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_Btn_ToolTip";
                ...
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Btn_ServerTask", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Btn_ServerTask";
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Btn_DBOpen", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Btn_DBOpen";
                sqa.InsertCommand.Parameters.Add("@DDM_Menu_Hdr_Btn_DBRefresh", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Btn_DBRefresh";
                ...
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Order", SqlDbType.Int).SourceColumn = "DDM_Menu_Hdr_Order";
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Option_Type", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Option_Type";
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Dim_Type", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_Dim_Type";
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Dim_Name", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_Dim_Name";
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_MFB", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_MFB";
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Default", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_Default";
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Btn", SqlDbType.Bit).SourceColumn = "DDM_Menu_Hdr_Fltr_Btn";
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Btn_Lbl", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_Btn_Lbl";
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Fltr_Btn_ToolTip", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Fltr_Btn_ToolTip";
                ...
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Btn_ServerTask", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Btn_ServerTask";
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Btn_DBOpen", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Btn_DBOpen";
                sqa.UpdateCommand.Parameters.Add("@DDM_Menu_Hdr_Btn_DBRefresh", SqlDbType.NVarChar).SourceColumn = "DDM_Menu_Hdr_Btn_DBRefresh";
